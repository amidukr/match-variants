...
The local type alias can also declare generics. This is useful when the
variant-associated type is generic over parameters chosen by the operation:
...
Conceptually, the generated alias includes the supplied generic parameters:
